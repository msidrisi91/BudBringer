...
class Chat extends StatelessWidget {
  ...
  final String id;
  final String name;
  Chat({Key key, @required this.peerId, @required this.peerAvatar, @required this.id, @required this.name}) : super(key: key);
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future uploadFile() async {
    ...
    imageFile = await  StorageService.compressImage(fileName, imageFile);
  ...
  void onSendMessage(String content, int type) {
    Firestore.instance.collection('users').document(peerId).updateData({'unreadmessagecount': FieldValue.increment(1)});
    if (content.trim() != '') {
